...
internal class EventEntryServiceTest {
    ...
    fun setUp() {
        ...
        val repoField = EventEntryService::class.java.getDeclaredField("competitorRepository")
        repoField.isAccessible = true
        repoField.set(eventEntryService, competitorRepository)
        
        val restTemplateField = EventEntryService::class.java.getDeclaredField("restTemplate")
        restTemplateField.isAccessible = true
        restTemplateField.set(eventEntryService, restTemplate)
        
        val baseUrlField = EventEntryService::class.java.getDeclaredField("eventorApiBaseUrl")
